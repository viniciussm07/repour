...
export default function InfosSection() {
  return (
    <section
      id="infos"
      className="bg-red-700 flex flex-col items-center p-2 md:p-8 text-white"
    >
      <h2 className="text-3xl md:text-4xl py-5">Infos</h2>
      <div className="md:flex text-xl md:text-3xl">
        <div className="flex-1 m-8 md:m-16">
          <ul className="space-y-5 mb-8 md:mb-20">
            <li>
              ...
              e próximo a{" "}
              <span className="text-yellow-400">
                farmácias, mercados, restaurantes e bares.
              </span>
              ;
            </li>
            <li>
