...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="h-screen md:flex md:items-center md:justify-center bg-cover bg-no-repeat bg-top md:bg-fixed bg-neutral-800 bg-[url('/our-photos/churrasco-dos-pais-teste.jpg')] md:bg-[url('/our-photos/reencontrOUR.jpeg')] tracking-wide"
    >
